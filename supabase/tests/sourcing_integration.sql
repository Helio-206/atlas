...
insert into procurement.purchase_requests(id,company_id,project_id,request_number,requested_by,purpose,priority,required_date,status,estimated_total,currency,created_by,version)
select '64000000-0000-4000-8000-000000000001','62000000-0000-4000-8000-000000000001','63000000-0000-4000-8000-000000000001','SRC-PR-001','61000000-0000-4000-8000-000000000001','Approved sourcing request','normal','2026-10-01','approved',350,'AOA','61000000-0000-4000-8000-000000000001',1
where false;
-- created_by is not a purchase_requests column; insert explicitly with valid columns.
