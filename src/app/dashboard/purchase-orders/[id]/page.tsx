...
export default async function PurchaseOrderPage({ params, searchParams }: Props) {
  ...
  const [items, receiptStatus, receipts, audit, query] = await Promise.all([
